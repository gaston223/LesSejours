    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('coverImage', UrlType::class, $this->getConfiguration(
                "URL de l'image principale", "donnez l'adresse d'une image qui donne vraiment envie"
            ))
            ...
            ->add('content', TextareaType::class, $this->getConfiguration(
                ...
                "Donnez une description qui donne vraiment envie de venir chez vous"
            ))
            ...
            ->add('price', MoneyType::class, $this->getConfiguration(
                "Prix par nuit",
                "Indiquez le prix que vous voulez par nuit"
            ))
